...
internal class ParticleFeedbackRenderer(
  ...
  private object Cfg {
    ...
    const val DECAY = 0.910f
    const val DIFFUSE = 0.005f
    const val BRIGHT = 0.015f
    const val EXPOSURE = 0.65f
    const val CHROMATIC_ABERRATION = 0.006f
    const val GRAIN = 0.025f
    const val VIGNETTE = 0.0f // Zero vignette to prevent dark corners
  }
