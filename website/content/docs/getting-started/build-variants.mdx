...
description: Choose between Standard, Play Store, No Vulkan, and FongMi distributions.
---

mpvRx has three native playback profiles. The Play Store distribution reuses the Standard profile with policy-specific storage, permission, and update behavior.
...
| **Play Store** | You install through Google Play and want the Standard engine with scoped storage and Play-managed updates. | Android App Bundle delivered by Google Play. |
